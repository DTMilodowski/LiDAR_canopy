...
plots_b = [b'Belian',b'E',b'B North']
plots = ['Belian','E','B North']
chm_files = ['CHM_50cm_Belian.npy','CHM_50cm_E.npy','CHM_50cm_BNorth.npy']
chm = {}
...
# Plot up the figure
labels = ['Old growth (MLA-01)','Moderately logged (SAF-03)','Heavily logged (SAF-02)']
fig,axes = plt.subplots(nrows=1,ncols=3,figsize=[9,3.5],subplot_kw={'aspect':'equal',
...
for pp,ax in enumerate(axes):
    ...
    #line = ax.plot(N[:,0],N[:,1],'-',color='white')[0]
